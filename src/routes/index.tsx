...
const NANER_WAKE =
  "naner|nanner|nanar|naneir|nander|nanor|nener|nane|nana|nanan|nanam|nanna|nanah|nanae|nani|nany|nanni|raner|ranner|daner|danner|taner|tanner|zaner|vaner";
